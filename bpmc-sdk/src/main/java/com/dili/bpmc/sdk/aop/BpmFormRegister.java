package com.dili.bpmc.sdk.aop;

import com.dili.bpmc.sdk.annotation.BpmAction;
...
public class BpmFormRegister implements EnvironmentAware {
    ...
    public void setEnvironment(Environment environment) {
        contextPath = environment.getProperty("bpmn.server.address", DEFAULT_CONTEXT_PATH);
    }
}
