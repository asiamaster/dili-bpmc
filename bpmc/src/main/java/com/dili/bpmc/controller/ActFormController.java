...
public class ActFormController {
	...
	public String dynamicForm(@RequestParam(required = false) String formKey, @RequestParam(required = false) String processDefinitionId, @RequestParam(required = false) String taskId,
			@RequestParam(required = false, defaultValue = "false") boolean cover, ModelMap modelMap) {
