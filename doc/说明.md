...
drop table if exists act_task_title;

/*==============================================================*/
/* Table: act_task_title                                        */
/*==============================================================*/
create table act_task_title
(
   id                   bigint not null auto_increment,
   title                varchar(10) comment '任务标题HTML模板',
   process_definition_id varchar(64) comment '流程定义id',
   creater_id           bigint comment '创建人',
...
alter table act_task_title comment '任务标题设置';
